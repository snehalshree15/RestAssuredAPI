...
public class TC002_create_New_Employee extends TestBase {
	...
	void createEmployee() {
		...
		logger.info("*************Started TC002 Create new Employee");
		...
		respone = httpRequest.request(Method.POST, "/create");
	...
	@AfterClass
	void tearDown() {
		logger.info("***Ended TC002 Create new employee");
	}
